<?php $__env->startSection('title', 'Home | Meditrust Nepal'); ?>

<?php $__env->startSection('content'); ?>
    <?php $hp = $homepage['data'] ?? $homepage ?? null; ?>
    ...
    <section class="bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
                <div>
                    <div class="inline-flex items-center px-3 py-1 rounded-full bg-white/10 text-sm mb-4"><?php echo e($hp['hero_badge'] ?? "Nepal's Trusted Surgical Equipment Partner"); ?></div>
                    <h1 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight"><?php echo nl2br(e($hp['hero_title'] ?? 'Surgical Equipment\nBuilt for Excellence')); ?></h1>
                    <p class="mt-4 text-white/90 max-w-2xl"><?php echo e($hp['hero_subtitle'] ?? 'Supplying certified surgical instruments, operating room equipment, and medical devices to hospitals and clinics across Nepal — with expert support from day one.'); ?></p>
    ...
    <section class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                ?>
                <?php $__currentLoopData = $range; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="/products?category=<?php echo e(urlencode($r)); ?>" class="group bg-white border border-gray-100 rounded-xl p-4 hover:shadow-md transition">
                        <div class="text-sm text-primary-600 font-semibold mb-2"><?php echo e($r); ?></div>
                        <div class="text-sm text-gray-500">Explore <?php echo e($r); ?> equipment and supplies.</div>
                    </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dmk/Desktop/medi-main/laravel-backend/resources/views/home.blade.php ENDPATH**/ ?>