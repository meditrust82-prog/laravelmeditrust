<?php $__env->startSection('title', 'Blog — Medical Equipment Insights | Meditrust Nepal'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <a href="/blog/<?php echo e($blogSlug); ?>"
                   class="bg-white dark:bg-dark-card rounded-xl overflow-hidden shadow-sm hover:shadow-md group border border-gray-100 dark:border-dark-border flex flex-col transition-all">
                    <div class="h-48 bg-gray-100 dark:bg-gray-800 overflow-hidden">
                        <?php if($blogImage): ?>
                            <img src="<?php echo e($blogImage); ?>" alt="<?php echo e($blogTitle); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" loading="lazy" />
                        <?php else: ?>
                    ...
                    <div class="p-6 flex flex-col flex-1">
                        <div class="flex items-center text-xs text-gray-500 gap-3 mb-3 flex-wrap">
                            <?php if($blogCat): ?>
                                <span class="bg-primary-50 text-primary-600 px-2 py-0.5 rounded font-medium dark:bg-primary-900/30 dark:text-primary-400"><?php echo e($blogCat); ?></span>
                            <?php endif; ?>
                            <?php if($blogDate): ?>
                                <span>📅 <?php echo e(\Carbon\Carbon::parse($blogDate)->format('M j, Y')); ?></span>
                            <?php endif; ?>
                        </div>
                        <h2 class="font-semibold text-gray-900 dark:text-white group-hover:text-primary-600 transition-colors line-clamp-2 mb-2"><?php echo e($blogTitle); ?></h2>
                        <p class="text-gray-500 dark:text-gray-400 text-sm line-clamp-2 flex-1"><?php echo e($blogExcerpt); ?></p>
                        <div class="mt-4 flex items-center justify-between">
                            <span class="text-xs text-gray-400">👤 <?php echo e($blogAuthor); ?></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dmk/Desktop/medi-main/laravel-backend/resources/views/blog.blade.php ENDPATH**/ ?>