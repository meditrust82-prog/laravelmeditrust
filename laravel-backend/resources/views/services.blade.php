...
@section('title', 'Our Services | Meditrust Nepal')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach($services as $svc)
                <div class="bg-white dark:bg-dark-card rounded-2xl p-7 shadow-sm border border-gray-100 dark:border-dark-border hover:shadow-md transition-all hover:-translate-y-0.5 group">
                    ...
                    <span class="inline-block bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 text-xs font-semibold px-3 py-1 rounded-full mb-3">{{ $svc['badge'] }}</span>
                    <h2 class="text-lg font-bold text-gray-900 dark:text-white mb-3 group-hover:text-primary-600 transition-colors">{{ $svc['title'] }}</h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @foreach([['1','Inquiry','Contact us via WhatsApp, phone, or our online form with your requirements.'],['2','Quotation','We send a detailed quotation within 24 hours, including specifications and pricing.'],['3','Delivery','Equipment is shipped and delivered to your facility across Nepal.'],['4','Installation','Our team installs, commissions and trains your staff on all equipment.']] as [$step,$title,$desc])
                <div class="relative bg-gray-50 dark:bg-dark-card rounded-2xl p-6 border border-gray-100 dark:border-dark-border text-center">
                    <div class="w-12 h-12 bg-primary-600 text-white rounded-2xl flex items-center justify-center text-xl font-black mx-auto mb-4">{{ $step }}</div>
...
<section class="py-16 bg-primary-700">
    <div class="max-w-3xl mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://wa.me/9779818100515?text={{ urlencode('Hello, I would like to inquire about Meditrust Nepal services.') }}"
