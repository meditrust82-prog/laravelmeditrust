...
@section('title', 'Brand: ' . ucwords(str_replace('-', ' ', $brandSlug ?? 'All')) . ' | Meditrust Nepal')
    ...
    <section class="py-6 sm:py-12 bg-gray-50 dark:bg-dark-surface min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <h1 class="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-2">{{ ucwords(str_replace('-', ' ', $brandSlug ?? 'All')) }}</h1>
