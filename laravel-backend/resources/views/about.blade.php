...
@section('title', 'About Meditrust Nepal | Medical Equipment Supplier Nepal')
...
<section class="bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl">
            <span class="inline-block bg-white/10 text-blue-200 text-sm font-medium px-4 py-1.5 rounded-full mb-5">{{ $heroLabel }}</span>
            <h1 class="text-4xl sm:text-5xl font-bold text-white leading-tight mb-5">{{ $heroTitle }}</h1>
            <p class="text-blue-100 text-lg leading-relaxed max-w-2xl">{{ $heroDesc }}</p>
        </div>
    </div>
</section>
...
<section class="bg-white dark:bg-dark-card border-b border-gray-100 dark:border-dark-border">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 sm:grid-cols-4 divide-x divide-gray-100 dark:divide-dark-border">
            @foreach([['15+','Years in operation'],['500+','Products supplied'],['200+','Hospitals served'],['24/7','After-sales support']] as [$num,$label])
                <div class="py-8 px-6 text-center">
                    <p class="text-3xl font-extrabold text-primary-700">{{ $num }}</p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-300 leading-relaxed mb-5">{{ $storyPara1 }}</p>
                <p class="text-gray-600 dark:text-gray-300 leading-relaxed">{{ $storyPara2 }}</p>
            </div>
            <div class="space-y-6">
...
<section class="py-16 bg-primary-700">
    <div class="max-w-3xl mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://wa.me/9779818100515?text={{ urlencode('Hello Meditrust Nepal, I would like to inquire about medical equipment.') }}"
